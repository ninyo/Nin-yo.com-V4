...
function header_main(){
	...
	$array_toptext[] = array(
		"Visuals and ideas can be powerful and leave long lasting impressions from the things we look at, to the interfaces we use daily. Being able to create those things for people is one of the reasons why I enjoy this type of work.",
		);
	/* ——————————————————————————————————
	DESCRIPTION:
	——————————————————————————————————— */
			...
			$output = $output . '<div class="inner">';
				...
				$output = $output . '<div class="content_bio">';
					...
					$output = $output . '<div class="paragraph">';
						$output = $output . "<p style='margin-bottom:15px;'>I'm interested in creating the things people take time to: look at, digest, interact, read, experience, etc. It's almost an art piece by the process of how it was designed. If you think about it, it's nice to pick up a well designed <i>anything</i> once in a while, and just appreciate what you're looking at, or even purchasing (like a magazine or book).</p>"; 
						$output = $output . "<p style='margin-bottom:15px;'>Nowadays with all the good looking social media / tech startup sites, the visual bar out there is pretty much standardized and high. One of the thoughts that come to mind is \"are these ideas working well for the users and how are they using them?\" with the integration of that visual bar. My goal now is to understand those answers through the use of exploring new ideas and just seeing how it all works.</p>";
