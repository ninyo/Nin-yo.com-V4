			...
			$output = $output . '<div class="inner">';
				...
				$output = $output . '<div class="content_bio">';
					...
					$output = $output . '<div class="paragraph">';
						...
						$lot = date('Y') - 2007;
						$output = $output . "<p style='margin-bottom:15px;'>With about ".$lot."+ years of experience, I've been involved in designing a number of awesome projects from: financial applications, competition events, branding, social media platforms for videographers, and a lot more to come. My experience involves visual design, interaction design, digital prototyping. To an extent, I also incorporate my knowledge in motion design, human-centered design, and programming (html, sass, php) to help influence my decisions in design.</p>";
						$output = $output . "<p style='margin-bottom:15px;'>Outside of work, I live in downtown Bremerton within walking distance to the Washington State Ferries, where I can access Seattle on a snazzy monthly-pass basis. At the end of the day, I'm a typical filipino dude that breakdances and drives a Honda civic listening to <a style='color:#2b2727;' href='https://youtu.be/LZmBVCHtu5g?t=39s' target='_blank'>\"Classic\" Hip&#8209;hop</a> & <a style='color:#2b2727;' href='https://youtu.be/FKqf5lGvHYA?t=45m10s' target='_blank'>House</a> music.</p>";
...
function section_footer(){
	...
	$output = $output . '</div>';
	$output = $output . '<div class="section copyright"><p><span style="color:#665">&copy; '.date('Y').' Site designed by nin-yo.com. All Rights Reserved. Site design using pen on paper, Sketch, Sublime Text, and <a href="http://github.com/ninyo" target="none" style="text-decoration:none;color:#665;font-weight:bold;">Github</a></span></p></div>';
	/* ———————————————————————————————— */
	return $output;}//close function
	/* ———————————————————————————————— */
